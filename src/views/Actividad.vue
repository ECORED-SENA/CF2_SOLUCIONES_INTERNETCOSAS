  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Conceptos sobre protocolos de comunicación
        p.mb-4 Apreciado participante, a continuación encontrará una actividad didáctica para afianzar los conceptos y aprendizajes del componente de formación.
          br
          br
          |Esta es una actividad donde encontrará conceptos relacionados con el componente que acaba de conocer y que deberá responder si es FALSO o VERDADERO.

        .tarjeta.tarjeta--azul.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
              p.fw-bold.mb-0 Conocer el aprendizaje sobre protocolos de comunicación en Internet Working
            .col-auto
